...
class StreakCalculatorTest{@Test fun countsConsecutiveDays(){val d=LocalDate.of(2026,9,6);assertEquals(3,StreakCalculator().calculate(setOf(d,d.minusDays(1),d.minusDays(2)),d))}}
