...
interface TavernRepository{suspend fun create(tavern:Tavern,owner:TavernMember);suspend fun get():Tavern?;suspend fun getById(id:String):Tavern?;suspend fun memberCount(tavernId:String):Int;fun observe():Flow<Tavern?>;fun observeForHero(heroId:String):Flow<List<Tavern>>;suspend fun getByCode(code:String):Tavern?;suspend fun join(tavernId:String,member:TavernMember):Boolean;suspend fun leave(tavernId:String,heroId:String)}
