...
@HiltViewModel
class JoinTavernViewModel @Inject constructor(private val taverns: TavernRepository, private val heroes: HeroRepository, private val ids: UuidProvider, private val time: DateProvider) : ViewModel() {
    ...
    fun join() = viewModelScope.launch {
        ...
        val tavern = taverns.getByCode(code) ?: run { _ui.update { it.copy(error = "Código não encontrado.") }; return@launch }
