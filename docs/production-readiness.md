...
- SHA-256 do arquivo exportado: `2ca936bd494f0240bee00f6027a690ec7f1040307800e9aad10b758f30cc73f4`.
...
- Account handlers: 3 testes passaram contra Firestore Emulator (autenticação ausente, concorrência/idempotência e perfil incompleto/inválido). ensureUserAccount e bootstrapProfile agora usam transações e validam classe/aparência. ensureUserAccount e bootstrapProfile publicadas com sucesso em tavernquest-7684e/southamerica-east1. Ambas responderam HTTP 401 UNAUTHENTICATED a uma chamada sem credenciais. Os testes de concorrência chamam os handlers diretamente; login com token real e App Check continuam pendentes.
